...
ca_childcare_long <- ca_childcare |> 
  pivot_longer(cols = c(mc_infant, mc_toddler, mc_preschool), names_to = "age_group", values_to = "cost")

ggplot(ca_childcare_long, aes(x = study_year, y = cost, color = age_group)) +
  geom_smooth(se = FALSE) +
  facet_wrap(~ region, scales = "free_y") +
  labs(
    title = "Center-based Childcare Costs Over Time in California",
    x = "Year",
    y = "Weekly Median Cost ($)",
    color = "Age Group"
  ) +
  theme_minimal()
